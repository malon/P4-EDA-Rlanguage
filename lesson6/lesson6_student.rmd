...
Response:
Non linear relationship, maybe exponential, maybe something else. Price increases with numbers of carats. If we paint a linear trend line, we that it doesn´t go through the center of the data in some key places.
***
